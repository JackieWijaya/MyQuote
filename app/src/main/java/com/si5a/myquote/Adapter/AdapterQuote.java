...
public class AdapterQuote extends RecyclerView.Adapter<AdapterQuote.ViewHolderQuote> {
    private List<QuoteModel> lisQuote = new ArrayList<>();
    private Context ctx;

    public AdapterQuote(List<QuoteModel> lisQuote, Context ctx) {
        this.lisQuote = lisQuote;
        this.ctx = ctx;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolderQuote holder, int position) {
        QuoteModel QM = lisQuote.get(position);
